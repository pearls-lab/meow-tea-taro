...
class AlfredThorEnv(object):
    ...
    class Thor(threading.Thread):
        ...
        def init_env(self, config):
            ...
            if not self.env:
                self.env = ThorEnv(scene="FloorPlan1",  # initialize 
        ...
        def reset(self, task_file):
            ...
            self.env.restore_scene(self.traj_data, object_poses, object_toggles, dirty_and_empty)
            ...
            return self._feedback, self._res
